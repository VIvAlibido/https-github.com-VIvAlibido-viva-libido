"""
Hearty Radio — Melodica Server

Liquidsoap automation server for the Melodica radio channel.
...
DB_PATH = '/var/lib/hearty/melodica.db'
...
def health():
    return jsonify({'status': 'ok', 'server': 'melodica'})
