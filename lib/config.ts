...
export const FEED_SOURCES: FeedSource[] = [
  // Spanish sources
  {
    ...
    url: 'https://www.diariodeibiza.es/rss/section/10001',
    language: 'es',
    enabled: true,
  },
  {
    name: 'Diario de Ibiza - Local',
    url: 'https://www.diariodeibiza.es/rss/section/10002',
    language: 'es',
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    language: 'en',
    keywords: ['ibiza', 'formentera', 'balearic'],
    enabled: true,
  },
  {
    name: 'Ibiza Spotlight',
    url: 'https://www.ibiza-spotlight.com/rss.xml',
    language: 'en',
    enabled: true,
  },
];
